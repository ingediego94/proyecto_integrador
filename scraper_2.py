...
#     # Capturar encabezados una sola vez
#     if not headers:
#         headers = [th.get_text(strip=True) for th in soup.select("th.header")]
...
#         row_data.append(cell0.get_text(strip=True) if cell0 else "")
...
# # 4. Guardar en CSV
# with open("riwi_logs.csv", "w", newline="", encoding="utf-8") as f:
#     writer = csv.writer(f)
